  ...
  if (document) {
    ...
    function openPopUp(e) {
      ...
      if(!document.getElementsByClassName('modal').length){
        ...
        popUp.innerHTML = '<div class="title">' + randomTextObj.title + '</div>';
        popUp.innerHTML += '<div class="content">' + randomTextObj.content + '</div>';
        document.body.appendChild(popUp);

        var cross = document.createElement('div');
        cross.className = 'cross';
        cross.innerText = 'x';
        document.getElementsByClassName('modal')[0].appendChild(cross);
        ...
        document.getElementsByClassName('modal')[0].appendChild(inputPhone);
        ...
        document.getElementsByClassName('modal')[0].appendChild(popUpContent);
      } else {
    ...
    function sendRequest(e) {
      ...
      function processRequest(e){
        if (xhr.readyState == 4 && xhr.status == 200) {
          ...
          document.getElementsByClassName('modal')[0].appendChild(promo);
          setTimeout(function () {
